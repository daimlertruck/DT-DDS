var n=Object.defineProperty;var i=(t,r)=>n(t,"name",{value:r,configurable:!0});import{j as s}from"./jsx-runtime-Cgz2XvFB.js";import{r as c}from"./index-CwbBKW39.js";import{f as d}from"./emotion-styled.browser.esm-Cgg3GKEJ.js";import"./typography-B3nKKPHm.js";import"./index-BEKTSPqq.js";import"./index-DV-VXEUn.js";import{B as m}from"./z-index-BB_IPOEl.js";const f=i((t,r=1)=>{const[a,o,e]=(t.match(/\w\w/g)||[]).map(p=>parseInt(p,16));return`rgba(${a},${o},${e},${r})`},"hexToRgba"),l={dark:.85,light:.2},g=d.div`
  ${({theme:t,type:r})=>`
      width: 100vw;
      height: 100vh;
      position: fixed;
