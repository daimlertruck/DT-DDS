import{j as r}from"./jsx-runtime-CB_V9I5Y.js";import{r as u}from"./index-CTjT7uj6.js";import{I as f}from"./Icon-DG6KDu5A.js";import{f as n,d as h}from"./emotion-styled.browser.esm-DBghOYGd.js";const b=(t,o,e)=>o?`
        border: none;
...
`,w=n.span`
  ...
  `}
`,S=u.forwardRef(({dataTestId:t="checkbox-id",onChange:o,children:e,isChecked:l=!1,isDisabled:a=!1,style:c,...p},d)=>{const s=h(),i=x=>{a||o==null||o(x)};return r.jsxs(g,{"data-testid":t,isChecked:l,isDisabled:a,style:c,children:[r.jsxs($,{children:[r.jsx(y,{checked:l,disabled:a,onChange:i,ref:d,type:"checkbox",...p}),l?r.jsx(f,{code:"check",color:s.palette.content.contrast}):null]}),e?r.jsx(w,{isChecked:l,isDisabled:a,children:e}):null]})});export{S as C};
