import{j as n}from"./jsx-runtime-CB_V9I5Y.js";import{r as i}from"./index-CTjT7uj6.js";import{c as f,G as w}from"./emotion-react.browser.esm-Bwsi5GpN.js";import{T as x}from"./Typography-ByfpGKzH.js";import{I as $}from"./IconButton-C_mszqXk.js";import{f as d,d as y}from"./emotion-styled.browser.esm-DBghOYGd.js";import{C as h}from"./Close-BgpoXZkN.js";import"./index-D9dZuxfj.js";import"./index-BEZt9qJr.js";import"./index-XjDa9cP3.js";import{D as b}from"./z-index-CLLOsryR.js";const v=({title:e})=>n.jsx(x,{color:"content.dark",element:"h4",fontStyles:"h4",children:e}),D=d.header`
  ${({theme:e})=>`
    display: flex;
  ...
  `}
`,j={handleClose:()=>null},m=i.createContext(j),C=({handleClose:e,children:t})=>n.jsx(m.Provider,{value:{handleClose:e},children:t}),S=()=>{const e=i.useContext(m);if(!e)throw new Error("Drawer compound components cannot be rendered outside the Drawer component");return e},_=({children:e})=>{const{handleClose:t}=S();return n.jsxs(D,{"data-testid":"drawer-header",children:[n.jsx("div",{children:e}),n.jsx($,{color:"default",dataTestId:"drawer-close-button",onClick:t,children:n.jsx(h,{})})]})},E=d.section`
  ${({theme:e})=>`
    position: relative;
    overflow: auto;
...
`,L=d.div`
  ...
  `}
`,R=e=>parseFloat(e.replace(/[^\d.]/g,""))*1e3,p=({isVisible:e,setIsVisible:t,children:l,dataTestId:a})=>{const[c,o]=i.useState(!1),s=y(),r=i.useCallback(()=>{o(!1),setTimeout(()=>{t(!1)},R(s.animations.emphasizedDecelerate.timingFunction))},[t,s.animations.emphasizedDecelerate.timingFunction]);return i.useEffect(()=>{const u=g=>{g.key==="Escape"&&r()};return o(e),document.addEventListener("keydown",u),()=>{document.removeEventListener("keydown",u)}},[r,e]),n.jsx(C,{handleClose:r,children:n.jsxs(I,{children:[e?n.jsx(w,{styles:z}):null,n.jsx(F,{"data-testid":"drawer-overlay",isVisible:c,onClick:r}),n.jsx(L,{"data-testid":a??"drawer-content-container",isVisible:c,children:l})]})})};p.Title=v;p.Header=_;p.Body=T;export{p as D};
