import{j as o}from"./jsx-runtime-CB_V9I5Y.js";import{T as m}from"./Typography-ByfpGKzH.js";import{f as v,d as M}from"./emotion-styled.browser.esm-DBghOYGd.js";import{r as l}from"./index-CTjT7uj6.js";import{B}from"./index-CWvrgZ1b.js";import{I as O}from"./Icon-DG6KDu5A.js";import{I as P}from"./IconButton-C_mszqXk.js";import"./index-D9dZuxfj.js";import"./index-9x84a4ck.js";import"./index-XjDa9cP3.js";import{b as T}from"./z-index-CLLOsryR.js";import{u as z}from"./useClickOutside-CvVYzr-_.js";const A=v.div`
  display: flex;
  align-items: center;
  padding-left: 15px;
  margin-top: 4px;
`,F=({dataTestId:t,isDisabled:e=!1,hasError:n=!1,children:r=""})=>{const s=e?"content.light":"content.medium";return o.jsx(A,{"data-testid":t??"dropdown-text",children:o.jsx(m,{color:n?"error.default":s,element:"span",fontStyles:"bodySmRegular",children:r})})},N=v.li`
  ${({theme:t,disabled:e,isSelected:n})=>`
    ...
    ${e&&`
      ...
      `}
  `}
`,h={state:{text:"",value:""},isOpen:!1,setState:()=>null,setIsOpen:()=>null},_=l.createContext(h),U=({children:t,defaultValue:e,name:n})=>{const[r,s]=l.useState(e??h.state),[i,c]=l.useState(h.isOpen);return l.useEffect(()=>e&&s(e),[e]),o.jsx(_.Provider,{value:{state:r,setState:s,isOpen:i,setIsOpen:c,name:n},children:t})},C=()=>{const t=l.useContext(_);if(!t)throw new Error("Dropdown compound components cannot be rendered outside the Dropdown component");return t},L=({dataTestId:t,option:e,children:n,style:r,isDisabled:s,onClick:i})=>{const{state:c,setState:f,setIsOpen:g,name:y}=C(),b=t??`dropdown-option-${e.value}`,p={text:e.text??e.value,value:e.value},u=x=>{s||(g(!1),f(p),i&&i(e.value,y,x))};return o.jsx(N,{"data-testid":b,disabled:s,isSelected:c.value===e.value,onClick:u,role:"option",style:r,children:n},e.value)},W=(t,e)=>({default:e.palette.surface.default,contrast:e.palette.surface.contrast,light:e.palette.surface.light})[t],X=v.button`
...
`,k=({children:t,dataTestId:e,style:n})=>o.jsx(Z,{"data-testid":`${e?e+"-":""}menu`,style:n,children:t}),q=({children:t,label:e,style:n,dataTestId:r="dropdown-select",isDisabled:s=!1,isRequired:i,hasBorder:c=!0,hasError:f=!1,hasDeselect:g=!1,variant:y="outlined",fill:b="default"})=>{const{state:p,setState:u,isOpen:x,setIsOpen:I}=C(),S=M(),D=l.Children.count(t)===1,$=s||D,j=$?S.palette.content.light:S.palette.content.default,E=a=>{a.preventDefault(),I(d=>!d)},R=a=>{a.stopPropagation(),u({text:"",value:""})};return l.useEffect(()=>{l.Children.toArray(t).find(d=>d.props.option.value===p.value)||u({text:"",value:""})},[t,u,p.value]),l.useEffect(()=>{if(D){const a=l.Children.map(t,d=>d&&d.props.option);if(a&&a[0]){const d={text:a[0].text??a[0].value,value:a[0].value};u(d)}}},[D,u,t]),o.jsxs(o.Fragment,{children:[o.jsxs(X,{"data-testid":r,disabled:$,fill:b,hasBorder:c,hasError:f,isOpen:x,onClick:E,style:n,variant:y,children:[o.jsxs("div",{style:{overflow:"hidden"},children:[o.jsxs(m,{color:$?"content.light":"content.default",fontStyles:"bodySmRegular",children:[e,i?o.jsx(m,{color:"error.default",element:"span",fontStyles:"bodySmRegular",children:"*"}):null]}),o.jsx(m,{color:$?"content.light":"content.default",fontStyles:"bodyMdRegular",style:{textOverflow:"ellipsis",overflow:"hidden"},children:p.value?p.text:"Select an option"})]}),o.jsxs(B,{style:{flexDirection:"row",gap:"0.5rem"},children:[g&&p.value?o.jsx(P,{onClick:R,children:o.jsx(O,{code:"close",color:j,dataTestId:"deselect-value",size:"s"})}):null,o.jsx(O,{code:x?"expand_less":"expand_more",color:j,size:"l"})]})]}),x?o.jsx(k,{dataTestId:r,children:t}):null]})},G=({children:t,style:e,dataTestId:n})=>{const{setIsOpen:r}=C(),s=l.useRef(null);return z({ref:s,handler:()=>r(!1)}),o.jsx("div",{"data-testid":n,ref:s,style:e,children:t})},H=v.div`
  ${({theme:t,style:e})=>`
    ...
    ${e}
  `}
`,w=({children:t,defaultValue:e,style:n,name:r,dataTestId:s="dropdown"})=>o.jsx(U,{defaultValue:e,name:r,children:o.jsx(H,{"data-testid":s,role:"menu",style:n,children:t})});w.Container=G;w.Detail=F;w.Select=q;w.Option=L;w.Menu=k;export{w as D};
