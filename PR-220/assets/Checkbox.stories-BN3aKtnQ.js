var E=Object.defineProperty;var a=(n,r)=>E(n,"name",{value:r,configurable:!0});import{j as e}from"./jsx-runtime-Cgz2XvFB.js";import{r as k}from"./index-CwbBKW39.js";import{C as s}from"./Checkbox-Fi0eMJlN.js";import"./Icon-Cizr_oyr.js";import"./emotion-styled.browser.esm-DNXn-wKZ.js";const A={title:"Data Display/Checkbox",component:s,argTypes:{size:{control:"radio",options:["small","large"],description:"Size variant of the checkbox"},isChecked:{control:"boolean",description:"Controlled checked state"},isDisabled:{control:"boolean",description:"Whether the checkbox is disabled"},isIndeterminate:{control:"boolean",description:"Whether the checkbox is in an indeterminate state"},hasError:{control:"boolean",description:"Whether the checkbox is in an error state"},label:{control:"text",description:"Label text for the checkbox"}},args:{size:"large",isDisabled:!1,isIndeterminate:!1,hasError:!1,isChecked:!1}},i={args:{label:"Checkbox label"},render:a(n=>{const r=a(()=>{const[l,t]=k.useState(n.isChecked);return e.jsx(s,{...n,isChecked:l,onChange:a(c=>t(c.target.checked),"onChange")})},"CheckboxWrapper");return e.jsx(r,{})},"render"),parameters:{docs:{source:{code:`
...
}`,...(x=(m=i.parameters)==null?void 0:m.docs)==null?void 0:x.source}}};var u,g,p;d.parameters={...d.parameters,docs:{...(u=d.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => {
    const CheckboxWrapper = () => {
      const [indeterminate, setIndeterminate] = useState(true);
      const [checked, setChecked] = useState(false);
...
}`,...(p=(g=d.parameters)==null?void 0:g.docs)==null?void 0:p.source}}};var f,z,I;h.parameters={...h.parameters,docs:{...(f=h.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '40px'
  }}>
...
}`,...(I=(z=h.parameters)==null?void 0:z.docs)==null?void 0:I.source}}};var j,y,S;o.parameters={...o.parameters,docs:{...(j=o.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => <div style={{
    width: 300,
    display: 'flex',
    flexDirection: 'column',
...
}`,...(S=(y=o.parameters)==null?void 0:y.docs)==null?void 0:S.source}}};const _=["Default","IndeterminateToggle","AllSizesAndStates","LongLabelWrapping"];export{h as AllSizesAndStates,i as Default,d as IndeterminateToggle,o as LongLabelWrapping,_ as __namedExportsOrder,A as default};
