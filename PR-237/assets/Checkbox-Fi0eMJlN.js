var I=Object.defineProperty;var i=(e,r)=>I(e,"name",{value:r,configurable:!0});import{j as d}from"./jsx-runtime-Cgz2XvFB.js";import{r as f}from"./index-CwbBKW39.js";import{I as _}from"./Icon-Cizr_oyr.js";import{f as b,j as v,d as A}from"./emotion-styled.browser.esm-DNXn-wKZ.js";const P={small:20,large:24},W=1,G={small:16,large:20},K=i(e=>({disabled:{active:{bg:e.palette.informative.light,border:"transparent"},inactive:{bg:e.palette.informative.light,border:e.palette.informative.medium}},default:{active:{normal:{bg:e.palette.informative.default,border:"transparent",hover:e.palette.informative.dark},error:{bg:e.palette.error.default,border:"transparent",hover:e.palette.error.dark}},inactive:{normal:{bg:e.palette.surface.contrast,border:e.palette.informative.default,hover:e.palette.informative.light},error:{bg:e.palette.surface.contrast,border:e.palette.error.default,hover:e.palette.error.light}}}}),"getCheckboxColors"),N=i((e,r,t,n,a)=>{const s=K(e),l=r||t?"active":"inactive";if(n)return s.disabled[l];const c=a?"error":"normal";return s.default[l][c]},"getCheckboxState"),T=b("label",{shouldForwardProp:i(e=>v(e)&&!e.startsWith("$"),"shouldForwardProp")})`
  display: inline-flex;
  align-items: center;
