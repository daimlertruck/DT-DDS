...
`,V=p("div",{shouldForwardProp:n(e=>x(e)&&!e.startsWith("$"),"shouldForwardProp")})`
  ...
  `}
`;function Z(...e){return r=>{for(const t of e)t&&(typeof t=="function"?t(r):t&&(t.current=r))}}n(Z,"mergeRefs");const _=v.forwardRef(({dataTestId:e="checkbox",onChange:r,isChecked:t=!1,isDisabled:o=!1,isIndeterminate:a=!1,hasError:l=!1,size:c="large",label:s,children:i,style:m,id:$,"aria-label":y,...k},j)=>{const S=L(),u=v.useRef(null),R=Z(u,j);v.useEffect(()=>{u.current&&(u.current.indeterminate=a)},[a]);const w=n(F=>{o||r==null||r(F)},"handleChange"),b=!!(s||i),g=$||(b?e:void 0),h=a?"remove":t?"check":null,C=c==="small"?"medium":"large";return d.jsxs(B,{$disabled:o,"data-testid":e,htmlFor:g,style:m,children:[d.jsx(M,{"aria-checked":a?"mixed":void 0,"aria-invalid":l,"aria-label":b?void 0:y||"Checkbox",checked:t,disabled:o,id:g,onChange:w,ref:R,type:"checkbox",...k}),d.jsx(N,{$checked:t,$disabled:o,$error:l,$indeterminate:a,$size:c,children:h?d.jsx(E,{code:h,color:S.palette.content.contrast,size:C}):null}),b?d.jsx(V,{$disabled:o,$size:c,children:s||i}):null]})});_.displayName="Checkbox";export{_ as C};
