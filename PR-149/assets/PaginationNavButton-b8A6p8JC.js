...
`,A=e.span`
  ${({theme:t})=>`
    ...
    white-space: nowrap;
  `}
`,h=g.memo(({ariaLabel:t,tooltipLabel:n,icon:c,targetPage:p,isDisabled:s,testId:u,onClick:f})=>{const l=i.jsx(b,{"aria-label":t,"data-testid":u,disabled:s,onClick:a(()=>f(p),"onClick"),children:i.jsx($,{code:c,size:"small"})});return s?l:i.jsxs(d,{children:[l,i.jsx(d.Content,{background:"full",direction:"top",children:n})]})});h.displayName="PaginationNavButton";export{k as F,j as I,N,_ as P,B as T,R as a,E as b,A as c,h as d,W as e};
