var w=Object.defineProperty;var s=(e,n)=>w(e,"name",{value:n,configurable:!0});import{j as t}from"./jsx-runtime-Cgz2XvFB.js";import{r as d}from"./index-CwbBKW39.js";import{c as x,G as $}from"./emotion-react.browser.esm-BzOLYAw5.js";import{T as y}from"./Typography-Dk4smw7A.js";import{I as h}from"./Icon-BWIy_dZb.js";import{I as b}from"./IconButton-DqfnmDe3.js";import{f as c,d as v}from"./emotion-styled.browser.esm-CIRWz9XU.js";import"./typography-B3nKKPHm.js";import"./index-CmOmo3jR.js";import"./index-DV-VXEUn.js";import{D}from"./z-index-C44GOntP.js";const j=s(({title:e})=>t.jsx(y,{color:"content.dark",element:"h4",fontStyles:"h4",children:e}),"DrawerTitle"),S=c.header`
  ${({theme:e})=>`
    display: flex;
  ...
  `}
`,_={handleClose:s(()=>null,"handleClose")},g=d.createContext(_),C=s(({handleClose:e,children:n})=>t.jsx(g.Provider,{value:{handleClose:e},children:n}),"DrawerContextProvider"),E=s(()=>{const e=d.useContext(g);if(!e)throw new Error("Drawer compound components cannot be rendered outside the Drawer component");return e},"useDrawerContext"),k=s(({children:e})=>{const{handleClose:n}=E();return t.jsxs(S,{"data-testid":"drawer-header",children:[t.jsx("div",{children:e}),t.jsx(b,{color:"default",dataTestId:"drawer-close-button",onClick:n,children:t.jsx(h,{code:"close",size:"large"})})]})},"DrawerHeader"),T=c.section`
  ${({theme:e})=>`
    position: relative;
    overflow: auto;
