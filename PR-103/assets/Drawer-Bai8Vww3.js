var w=Object.defineProperty;var s=(e,n)=>w(e,"name",{value:n,configurable:!0});import{j as t}from"./jsx-runtime-Cgz2XvFB.js";import{c as x,G as $}from"./emotion-react.browser.esm-DSneuyqi.js";import{r as d}from"./index-CwbBKW39.js";import{T as y}from"./Typography-CEwLj33J.js";import{I as h}from"./IconButton-BxQ2uS0G.js";import{C as b}from"./Close-BB6prpXj.js";import{f as c,d as v}from"./emotion-styled.browser.esm-Cgg3GKEJ.js";import"./typography-B3nKKPHm.js";import"./index-DZ0xzJa4.js";import"./index-DV-VXEUn.js";import{a as D}from"./z-index-BB_IPOEl.js";const j=s(({title:e})=>t.jsx(y,{color:"content.dark",element:"h4",fontStyles:"h4",children:e}),"DrawerTitle"),C={handleClose:s(()=>null,"handleClose")},g=d.createContext(C),S=s(({handleClose:e,children:n})=>t.jsx(g.Provider,{value:{handleClose:e},children:n}),"DrawerContextProvider"),_=s(()=>{const e=d.useContext(g);if(!e)throw new Error("Drawer compound components cannot be rendered outside the Drawer component");return e},"useDrawerContext"),E=c.header`
  ${({theme:e})=>`
    display: flex;
  ...
  `}
`,k=s(({children:e})=>{const{handleClose:n}=_();return t.jsxs(E,{"data-testid":"drawer-header",children:[t.jsx("div",{children:e}),t.jsx(h,{color:"default",dataTestId:"drawer-close-button",onClick:n,children:t.jsx(b,{})})]})},"DrawerHeader"),T=c.section`
  ${({theme:e})=>`
    position: relative;
    overflow: auto;
...
`,O=c.div`
  ...
  `}
`,q=s(e=>parseFloat(e.replace(/[^\d.]/g,""))*1e3,"animationToMiliseconds"),u=s(({isVisible:e,setIsVisible:n,children:p,dataTestId:o})=>{const[l,r]=d.useState(!1),a=v(),i=d.useCallback(()=>{r(!1),setTimeout(()=>{n(!1)},q(a.animations.emphasizedDecelerate.timingFunction))},[n,a.animations.emphasizedDecelerate.timingFunction]);return d.useEffect(()=>{const m=s(f=>{f.key==="Escape"&&i()},"handleKeyDown");return r(e),document.addEventListener("keydown",m),()=>{document.removeEventListener("keydown",m)}},[i,e]),t.jsx(S,{handleClose:i,children:t.jsxs(L,{children:[e?t.jsx($,{styles:F}):null,t.jsx(R,{"data-testid":"drawer-overlay",isVisible:l,onClick:i}),t.jsx(O,{"data-testid":o??"drawer-content-container",isVisible:l,children:p})]})})},"Drawer");u.Title=j;u.Header=k;u.Body=I;export{u as D};
