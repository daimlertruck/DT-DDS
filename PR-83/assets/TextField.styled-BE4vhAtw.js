import{s as e}from"./emotion-styled.browser.esm-BMKZqQy6.js";const d=(t,o)=>({default:o.palette.surface.default,contrast:o.palette.surface.contrast,light:o.palette.surface.light})[t]||o.palette.surface.default,p=e.div`
...
`,$=e.div`
  ${({theme:t,onClick:o})=>{const a=!!o;return`
    display: flex;
    cursor: ${a?"pointer":"default"};
    padding-right: ${t.spacing.spacing_40}};
...
`,g=e.div`
  ${({theme:t,isFloatingLabel:o,variant:a,backgroundFill:r,hasError:l})=>{const i=l?t.palette.error.default:t.palette.border.medium,n=l?t.palette.error.default:t.palette.informative.default;return`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
  ...
  `}}
`;export{c as I,p as T,g as a,f as b,u as c,$ as d,b as e};
