var h=Object.defineProperty;var i=(t,e)=>h(t,"name",{value:e,configurable:!0});import{j as r}from"./jsx-runtime-Cgz2XvFB.js";import{I as m}from"./Icon-BrO18bYS.js";import{r as b}from"./index-CwbBKW39.js";import{f as l,d as g}from"./emotion-styled.browser.esm-Cgg3GKEJ.js";const $=i((t,e,o)=>e?`
        border: none;
...
`,k=l.span`
  ...
  `}
`,T=b.forwardRef(({dataTestId:t="checkbox-id",onChange:e,children:o,isChecked:n=!1,isDisabled:a=!1,style:p,className:c,...d},s)=>{const u=g(),x=i(f=>{a||e==null||e(f)},"handleOnChangeTrigger");return r.jsxs(w,{className:c,"data-testid":t,isChecked:n,isDisabled:a,style:p,children:[r.jsxs(v,{children:[r.jsx(y,{checked:n,disabled:a,onChange:x,ref:s,type:"checkbox",...d}),n?r.jsx(m,{code:"check",color:u.palette.content.contrast,size:"medium"}):null]}),o?r.jsx(k,{isChecked:n,isDisabled:a,children:o}):null]})});export{T as C};
