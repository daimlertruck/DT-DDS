...
const DatePicker = (props: DatePickerProps) => {
  ...
  const formatDateToValue = (date: Date | DateRange) => {
    if (date instanceof Date) {
      setValue(format(date, DATE_FORMAT, { locale: enUS }));
      return;
    }
    ...
    const formattedFrom = format(from, DATE_FORMAT, { locale: enUS });
    const formattedTo = to ? format(to, DATE_FORMAT, { locale: enUS }) : '';
