...
| `initialValue`  | `Date`           | -       | Sets the initial value of the date picker.                                  |
...
| `weekStartDay`  | `number`         | `0`     | Specifies the day that teh weeks starts on the calendar                     |
| `isMultiMonth`  | `boolean`        | `false` | Specifies the number of months appearing when calendar is shown             |
| `locale`        | `Locale`         | `enUs`  | Specifies the locale                                                        |
