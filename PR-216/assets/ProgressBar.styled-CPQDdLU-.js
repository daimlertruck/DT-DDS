var d=Object.defineProperty;var t=(r,e)=>d(r,"name",{value:e,configurable:!0});import{f as a}from"./emotion-styled.browser.esm-DNXn-wKZ.js";const i={small:"4px",large:"8px"},s=t(r=>({active:{background:r.palette.informative.default,helper:r.palette.content.medium,percentage:r.palette.content.default},success:{background:r.palette.success.default,helper:r.palette.content.medium,percentage:r.palette.content.default},error:{background:r.palette.error.default,helper:r.palette.error.default,percentage:r.palette.error.default}}),"progressBarColors"),c=a.div`
  ${({theme:r})=>`
    display: flex;
