...
`,_t=(t,e)=>{let r=t.includes("top")?1:-1,[s,a]=N()?[At,Bt]:[Vt(r),zt(r)];return{animation:e?`${y(s)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${y(a)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},Ft=d.memo(({toast:t,position:e,style:r,children:s})=>{let a=t.height?_t(t.position||e||"top-center",t.visible):{opacity:0},o=d.createElement(Tt,{toast:t}),n=d.createElement(Dt,{...t.ariaProps},H(t.message,t));return d.createElement(Nt,{className:t.className,style:{...a,...r,...t.style}},typeof s=="function"?s({icon:o,message:n}):d.createElement(d.Fragment,null,o,n))});ct(d.createElement);var Rt=({id:t,className:e,style:r,onHeightUpdate:s,children:a})=>{let o=d.useCallback(n=>{if(n){let i=()=>{let l=n.getBoundingClientRect().height;s(t,l)};i(),new MutationObserver(i).observe(n,{subtree:!0,childList:!0,characterData:!0})}},[t,s]);return d.createElement("div",{ref:o,className:e,style:r},a)},Pt=(t,e)=>{let r=t.includes("top"),s=r?{top:0}:{bottom:0},a=t.includes("center")?{justifyContent:"center"}:t.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:N()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${e*(r?1:-1)}px)`,...s,...a}},Wt=O`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,E=16,Xt=({reverseOrder:t,position:e="top-center",toastOptions:r,gutter:s,children:a,containerStyle:o,containerClassName:n})=>{let{toasts:i,handlers:l}=vt(r);return d.createElement("div",{style:{position:"fixed",zIndex:9999,top:E,left:E,right:E,bottom:E,pointerEvents:"none",...o},className:n,onMouseEnter:l.startPause,onMouseLeave:l.endPause},i.map(c=>{let p=c.position||e,m=l.calculateOffset(c,{reverseOrder:t,gutter:s,defaultPosition:e}),g=Pt(p,m);return d.createElement(Rt,{id:c.id,key:c.id,onHeightUpdate:l.updateHeight,className:c.visible?Wt:"",style:g},c.type==="custom"?H(c.message,c):a?a(c):d.createElement(Ft,{toast:c,position:p}))}))};export{P as I,$ as T,Qt as a,Xt as b,U as c,f as n};
