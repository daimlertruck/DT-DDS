...
`,W=({children:t,style:o,dataTestId:s})=>f.jsx(j,{"data-testid":s??"table-body",style:o,children:t}),k=(t,o,s,r)=>{const n=new IntersectionObserver(([{isIntersecting:e}])=>{r((o>0||s>0)&&!e)},{threshold:1});return t.current&&n.observe(t.current),n},D=(t,o)=>l.Children.map(t,(s,r)=>l.isValidElement(s)?o(s,r):s),A=t=>[...t.children].map(s=>s.clientWidth),M=(t,o)=>o.slice(0,t).reduce((n,e)=>n+e,0),U=(t,o)=>o.slice(t+1).reduce((n,e)=>n+e,0),V=m.tr`
  ...
  `}
`,z=0,X=1,Z=({children:t,dataTestId:o,style:s,onClick:r})=>{const n=!!r,{columnsLength:e,setFixedColumns:d,setFixedEndColumns:a,fixedColumnCount:c,fixedEndColumnCount:u,isColumnsFixed:b,setShowBoxShadow:h}=C(),x=l.useRef(null);let i=t;if(b&&x.current){const y=[],E=[],$=[],T=A(x.current);i=D(t,(w,p)=>{let S=0;const R=p<c,_=p>=e-u;return R&&(S=M(p,T),y.push(p),$[z]=p),_&&(S=U(p,T),E.unshift(p),$[X]=$[1]??p),R||_?l.cloneElement(w,{...w.props,"data-column-index":p,"data-fixed-position":S}):w}),d(y),a(E),h($)}return f.jsx(V,{ref:x,...r&&{onClick:r},"data-testid":o??"table-row",selectableRow:n,style:s,children:i})},G=110,K=m.td`
  ${({theme:t,columnWidth:o,textAlign:s,showBoxShadow:r=!1,fixed:n=!1,fixedEnd:e=!1,fixedPosition:d=0})=>`
    ...
    ${(n||e)&&`
      ...
      `}
  `}
`,Y=({children:t,columnWidth:o,style:s,dataTestId:r,textAlign:n="left",...e})=>{const{fixedColumns:d,fixedEndColumns:a,showBoxShadow:c}=C(),u=Number(e["data-column-index"]),b=Number(e["data-fixed-position"]),h=d.indexOf(u),x=a.indexOf(u);let i={};return(d!=null&&d.length||a!=null&&a.length)&&(i={fixed:h!==-1,fixedEnd:x!==-1,showBoxShadow:c.includes(u),fixedPosition:b}),f.jsx(K,{columnWidth:o,"data-testid":r??"table-data-cell",style:s,textAlign:n,...i,...e,children:t})},q=m.table`
  ${({isFixed:t})=>`
