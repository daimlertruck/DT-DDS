import{j as o}from"./jsx-runtime-DMAvRu52.js";import{I as x}from"./Icon-87Ryblgq.js";import{T as u}from"./Tooltip-D-Xg6YZv.js";import{r as c}from"./index-Dl6G-zuu.js";import{n as g}from"./emotion-styled.browser.esm-Dv69Fly8.js";const $={selectedValue:void 0,showLabel:!0,onChange:()=>null,setSelectedValue:()=>null},b=c.createContext($),S=()=>{const t=c.useContext(b);if(!t)throw new Error("useSegmentedControlContext must be used within a SegmentedControlProvider");return t},f=({children:t,selectedValue:e,showLabel:n,onChange:r})=>{const[s,l]=c.useState(e);c.useEffect(()=>{l(e)},[e]);const i=a=>{r(a),l(a)};return o.jsx(b.Provider,{value:{selectedValue:s,setSelectedValue:i,showLabel:n,onChange:r},children:t})},C=g.button`
  ...
  `}
`,m=({label:t,iconCode:e,value:n,disabled:r})=>{const{setSelectedValue:s,showLabel:l,selectedValue:i}=S(),a=i===n,d=l||!e,p=o.jsxs(C,{"aria-label":t,"aria-pressed":a?"true":"false",disabled:r,onClick:()=>s(n),showLabel:d,type:"button",children:[e?o.jsx(x,{code:e,size:"s"}):null,d?t:null]});return d?p:o.jsxs(u,{children:[p,o.jsx(u.Content,{children:t})]})},y=g.div`
  ${({theme:t})=>`
    display: inline-flex;
    align-items: center;
