import{j as r}from"./jsx-runtime-CB_V9I5Y.js";import{B as $}from"./index-CWvrgZ1b.js";import{I as b}from"./Icon-DG6KDu5A.js";import{T as h}from"./Typography-DHEP7O00.js";import{r as f}from"./index-CTjT7uj6.js";import{f as m,d as S}from"./emotion-styled.browser.esm-DBghOYGd.js";const n={Default:"default",Error:"error",Info:"informative",Success:"success",Warning:"warning"},w={[n.Error]:"error",[n.Info]:"info",[n.Success]:"check_circle",[n.Warning]:"warning"},I=m.div`
  display: grid;
...
`,v=m.button`
  ...
  `}
`,y=({children:t,dataTestId:o,style:s,type:e=n.Default,onClose:a,description:l,title:c,orientation:d="horizontal"})=>{const i=S(),g=e===n.Default,u=d==="horizontal",j=!!a,x=g?"content.default":`${e}.dark`,k=g?i.palette.content.default:i.palette[e].dark,D=f.useMemo(()=>f.Children.map(t,p=>p&&f.cloneElement(p,{...p.props,type:e})),[t,e]);return r.jsxs(I,{"data-testid":o??"message",messageType:e,orientation:d,style:s,children:[!g&&r.jsx(b,{code:w[e],color:i.palette[e].dark,"data-testid":"message-icon",dataTestId:"message-icon"}),r.jsxs($,{dataTestId:"message-content",style:{flexDirection:u?"row":"column",justifyContent:"space-between",gap:u?i.spacing.spacing_30:i.spacing.spacing_50,alignItems:u?"center":"start"},children:[r.jsxs($,{style:{alignItems:"flex-start"},children:[c?r.jsx(h,{color:x,fontStyles:"bodyLgBold",children:c}):null,r.jsx(h,{color:x,fontStyles:"bodyLgRegular",children:l})]}),D]}),j?r.jsx(v,{"aria-label":"Close message",messageType:e,onClick:a,orientation:d,children:r.jsx(b,{code:"close",color:k})}):null]})};y.Actions=({children:t,dataTestId:o,type:s})=>r.jsx(_,{"data-testid":o??"message-actions",messageType:s,children:t});export{y as M,n as O};
