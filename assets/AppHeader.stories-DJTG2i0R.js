var Ce=Object.defineProperty;var s=(e,t)=>Ce(e,"name",{value:t,configurable:!0});import{j as i}from"./jsx-runtime-Cgz2XvFB.js";import{A as we}from"./Avatar-Dxg3ecAX.js";import{B as ce}from"./index-juXVSS06.js";import{t as h}from"./index-Dw_1laFD.js";import"./index-D29WkZXV.js";import{r as A,R as g}from"./index-CwbBKW39.js";import"./index-DV-VXEUn.js";import{u as N}from"./useMedia-CRgJMRRc.js";import{I as O}from"./Icon-BrO18bYS.js";import{I}from"./IconButton-BxQ2uS0G.js";import{T as B}from"./Typography-BDc1BtFV.js";import"./typography-B3nKKPHm.js";import{f as C,d as le}from"./emotion-styled.browser.esm-Cgg3GKEJ.js";import"./Tooltip-Po5dtPlC.js";import"./z-index-DkKqHUUA.js";import"./Avatar.styled-CxoZIEaX.js";import"./emotion-react.browser.esm-DSneuyqi.js";import"./index-6Tx4pmSd.js";import"./iframe-Bth4u_yP.js";const P=s(e=>{const t=s(a=>{const{hide:n,show:o,...r}=a,p=N(n||"(max-width: 0px)"),c=N(o||"(max-width: 0px)");return n&&p||o&&!c?null:i.jsx(e,{...r})},"ResponsiveComponent");return t.displayName=e.displayName||e.name||"Component",t},"withResponsive"),de=64,Ie=72,Se=52,me=1,$e="calc(100% / 3)",Te=54,He=170,je=250,_e=50,d={NAVIGATION:"AppHeader.Navigation",APP_NAME:"AppHeader.AppName",LOGO:"AppHeader.Logo",ACTIONS:"AppHeader.Actions"},Pe=C.header`
...
`,ue=A.createContext(null),Me=s(({value:e,children:t})=>i.jsx(ue.Provider,{value:e,children:t}),"AppHeaderContextProvider"),M=s(()=>{const e=A.useContext(ue);if(!e)throw new Error("AppHeader compound components must be used within AppHeader");return e},"useAppHeaderContext"),Ee=s((e,t,a,n)=>({isStandard:e==="standard",isCompact:e==="compact",isNavCenter:t==="center",isNavLeft:t==="left",isNavRight:t==="right",isNavCompact:e==="compact"||!a,hasAppName:!!a,isActionsPositionRight:n}),"computeHeaderState"),Le=s((e,t)=>e==="standard"&&!!t,"shouldCenterLogo"),y=s(e=>{var t;return(t=e.type)==null?void 0:t.displayName},"getDisplayName"),D=s((e,t)=>{const a=A.Children.toArray(e);for(const n of a)if(g.isValidElement(n)){if(t(n))return n;const o=n.props;if(o!=null&&o.children){const r=D(o.children,t);if(r)return r}}return null},"findChildRecursive"),R=s((e,t)=>D(e,a=>y(a)===t),"findChildByType"),ke=s((e,t,a,n)=>D(e,o=>{if(y(o)!==t)return!1;const r=o.props;return a in r&&r[a]===n}),"findChildByTypeAndProp"),Oe=s((e,t,a,n)=>A.Children.toArray(e).findIndex(r=>{if(!g.isValidElement(r)||y(r)!==t)return!1;const c=r.props;return a in c&&c[a]===n}),"findChildIndexByTypeAndProp"),z=s((e,t,a)=>{if(!g.isValidElement(e))return a;const n=e.props;return t in n&&n[t]!==void 0?n[t]:a},"extractProp"),he=s((e,t)=>{const a={};return A.Children.toArray(e).forEach((o,r)=>{if(g.isValidElement(o)){const p=y(o);p&&t.includes(p)&&(a[p]=r)}}),a},"findChildIndices"),G=s((e,t)=>Math.abs(e-t)===1,"areSiblings"),ge=s((e,t,a,n)=>{const o=g.Children.toArray(e),r=[];let p=0;for(;p<o.length;){const c=o[p],l=p+1<o.length?o[p+1]:null;if(g.isValidElement(c)&&g.isValidElement(l)){const m=y(c),u=y(l);if(m&&u&&t.includes(m)&&t.includes(u)&&G(p,p+1)){r.push(i.jsxs(ce,{style:{display:"flex",flexWrap:"nowrap",flexDirection:a?"column":"row",alignItems:a?"flex-start":"center",justifyContent:a?"center":"flex-start",height:a?"48px":"auto",gap:a?h.spacing.spacing_0:h.spacing.spacing_30,...n},children:[c,l]},`group-${p}`)),p+=2;continue}}r.push(c),p++}return r},"groupSiblingComponents"),Be=s(e=>!e.isNavRight||!e.isActionsPositionRight?!1:e.isCompact||e.isStandard&&!e.hasAppName,"shouldGroupNavigationAndActions"),De=s((e,t,a)=>{const n=e,r=he(n,[d.NAVIGATION,d.ACTIONS])[d.NAVIGATION]??-1,p=Oe(n,d.ACTIONS,"position","right");return r!==-1&&p!==-1&&G(r,p)?ge(n,[d.NAVIGATION,d.ACTIONS],t,{position:"fixed",right:a.spacing.spacing_60}):Array.isArray(e)?e:g.Children.toArray(e)},"groupNavigationAndActionsIfSiblings"),Ge=s(({type:e="standard",style:t,children:a,...n})=>{const o=le(),r=N(`(max-width: ${o.breakpoints.mq3}px)`),p=z(R(a,d.NAVIGATION),"position","center"),c=z(R(a,d.APP_NAME),"name",void 0),l=he(a,[d.APP_NAME,d.LOGO,d.NAVIGATION,d.ACTIONS]),m=l[d.APP_NAME]??-1,u=l[d.LOGO]??-1,v=Le(e,c),w=m!==-1&&u!==-1&&G(m,u),E=ke(a,d.ACTIONS,"position","right")!==null,x=Ee(e,p,c,E),L=A.useMemo(()=>({state:x,shouldCenterLogo:v,hasAppNameAsSibling:w,isMobile:r}),[x,v,w,r]),k=A.useMemo(()=>{let b=ge(a,[d.APP_NAME,d.LOGO],r);return Be(x)&&(b=De(b,r,o)),b},[a,x,r,o]);return i.jsx(Me,{value:L,children:i.jsx(Pe,{isMobile:r,style:t,...n,children:k})})},"AppHeader$1"),Re=s((e,t)=>e==="left"?"relative":t.isNavRight?t.isStandard&&t.hasAppName?"fixed":"relative":"fixed","getActionsPosition"),ze=s((e,t,a)=>{if(t==="left")return"auto";const n=e.spacing.spacing_60;return a.isNavRight?a.isStandard&&a.hasAppName?n:0:n},"getActionsRight"),Ve=s((e,t)=>{if(t==="left")return"auto";const{isNavLeft:a,isStandard:n,hasAppName:o}=e;return a&&n&&!o?"auto":$e},"getActionsMinWidth"),We=C.div`
  ${({theme:e,state:t,position:a="right"})=>{const n=Re(a,t),o=ze(e,a,t),r=Ve(t,a);return`
      ...
      gap: ${e.spacing.spacing_50};
    `}}
`,fe=s(({children:e,position:t="right",...a})=>{const n=le(),o=N(`(max-width: ${n.breakpoints.mq3}px)`),{state:r}=M();return i.jsx(We,{isMobile:o,position:t,state:r,...a,children:e})},"ActionsBase");fe.displayName="AppHeader.Actions";const qe=P(fe),V=C.div`
  ${({theme:e,state:t,isMobile:a})=>{const n=a&&t.isStandard;return`
    ...
    `}}
`,Ae=s(({name:e,children:t,...a})=>{const{state:n,isMobile:o}=M(),r=n.isStandard?"h5":"h5Bold",p=o?"h6Bold":r,c=t??e;return c?t?i.jsx(V,{isMobile:o,state:n,...a,children:c}):i.jsx(V,{isMobile:o,state:n,...a,children:i.jsx(B,{color:"primary.default",element:"span",fontStyles:p,children:c})}):null},"AppNameBase");Ae.displayName="AppHeader.AppName";const Xe=P(Ae),Fe=C.div`
  ${({shouldCenterLogo:e})=>`
      display: flex;
      flex-flow: row nowrap;
      align-items: center;
    ...
    `:""}
    `}
`,xe=s(({children:e,...t})=>{const{shouldCenterLogo:a,isMobile:n}=M(),o=a&&!n;return i.jsx(Fe,{shouldCenterLogo:o,...t,children:e})},"LogoBase");xe.displayName="AppHeader.Logo";const Je=P(xe),W={absoluteCenter:`
    position: absolute;
    left: 50%;
    top: 50%;
  ...
  `,autoMargins:`
    margin-left: auto;
    margin-right: auto;
  `},Ne=s(e=>e.isNavCenter?e.isNavCompact||!e.hasAppName:!1,"shouldUseAbsoluteCenter"),Ue=s(e=>Ne(e)?W.absoluteCenter:e.isNavCenter?W.autoMargins:"","getNavigationCenteringStyles"),Ke=s((e,t,a)=>e?"center":t?"flex-start":a?"flex-end":"center","getJustifyContent"),Ye=C.nav`
  ${({theme:e,state:t})=>{const{isStandard:a,hasAppName:n,isNavCompact:o,isNavLeft:r,isNavRight:p}=t,c=a&&n,l=Ne(t),m=c?"fixed":"relative",u=o?0:`${de}px`,v=o?"auto":"100%",w=o?"auto":`${Se}px`,E=l?"absolute":m,x=l?"50%":u,L=l?"50%":"0",k=l?"auto":"0",b=l?"auto":v,ve=Ke(l,r,p),be=Ue(t);return`
      position: ${E};
      top: ${x};
      left: ${L};
      right: ${k};
