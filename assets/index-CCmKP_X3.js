...
to {
  ...
  animation: ${_e} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,Ne=({toast:e})=>{let{icon:t,type:a,iconTheme:s}=e;return t!==void 0?typeof t=="string"?c.createElement(ze,null,t):t:a==="blank"?null:c.createElement(Te,null,c.createElement(Ie,{...s}),a!=="loading"&&c.createElement(Ae,null,a==="error"?c.createElement(je,{...s}):c.createElement(Se,{...s})))},Be=e=>`
