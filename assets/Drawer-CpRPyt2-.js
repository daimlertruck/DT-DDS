import{j as n}from"./jsx-runtime-DMAvRu52.js";import{c as f,G as w}from"./emotion-react.browser.esm-DLeKyOu_.js";import{r as i}from"./index-Dl6G-zuu.js";import{T as x}from"./Typography-D4QoQXTm.js";import{I as $}from"./IconButton-8pEMAeo8.js";import{C as y}from"./Close-mVzWqPf0.js";import{n as d,d as h}from"./emotion-styled.browser.esm-Dv69Fly8.js";import"./index-DjiMWOYD.js";import"./index-DIzpgGYl.js";import"./index-DCrStp1_.js";import{D as b}from"./z-index-Ds5QkyqS.js";const v=({title:e})=>n.jsx(x,{color:"content.dark",element:"h4",fontStyles:"h4",children:e}),D={handleClose:()=>null},m=i.createContext(D),S=({handleClose:e,children:t})=>n.jsx(m.Provider,{value:{handleClose:e},children:t}),j=()=>{const e=i.useContext(m);if(!e)throw new Error("Drawer compound components cannot be rendered outside the Drawer component");return e},C=d.header`
  ${({theme:e})=>`
    display: flex;
  ...
  `}
`,_=({children:e})=>{const{handleClose:t}=j();return n.jsxs(C,{"data-testid":"drawer-header",children:[n.jsx("div",{children:e}),n.jsx($,{color:"default",dataTestId:"drawer-close-button",onClick:t,children:n.jsx(y,{})})]})},E=d.section`
  ${({theme:e})=>`
    position: relative;
    overflow: auto;
...
`,L=d.div`
  ...
  `}
`,R=e=>parseFloat(e.replace(/[^\d.]/g,""))*1e3,p=({isVisible:e,setIsVisible:t,children:l,dataTestId:a})=>{const[c,o]=i.useState(!1),s=h(),r=i.useCallback(()=>{o(!1),setTimeout(()=>{t(!1)},R(s.animations.emphasizedDecelerate.timingFunction))},[t,s.animations.emphasizedDecelerate.timingFunction]);return i.useEffect(()=>{const u=g=>{g.key==="Escape"&&r()};return o(e),document.addEventListener("keydown",u),()=>{document.removeEventListener("keydown",u)}},[r,e]),n.jsx(S,{handleClose:r,children:n.jsxs(I,{children:[e?n.jsx(w,{styles:z}):null,n.jsx(F,{"data-testid":"drawer-overlay",isVisible:c,onClick:r}),n.jsx(L,{"data-testid":a??"drawer-content-container",isVisible:c,children:l})]})})};p.Title=v;p.Header=_;p.Body=T;export{p as D};
