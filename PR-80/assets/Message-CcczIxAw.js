...
`,j=o.div`
  ${({theme:t})=>`
    ...
    flex: 1;
    text-align: start;
    gap: ${t.spacing.spacing_10};
  `}
`,M=o.div`
  ${({theme:t})=>`
    padding-top: ${t.spacing.spacing_30};
  `}
`,m=o.div`
  ${({theme:t,type:s})=>`
    height: 100%;
...
`,$=o.button`
  ...
  `}
`,v={[n.Error]:h,[n.Info]:f,[n.Success]:x,[n.Warning]:C,[n.Default]:null},a=({children:t,dataTestId:s,style:d,type:r=n.Default,onClose:l})=>{const g=!!l,i=v[r];return e.jsxs(w,{"data-testid":s??"message",style:d,type:r,children:[i?e.jsx(m,{type:r,children:e.jsx(i,{"data-testid":"message-icon",height:"16px",width:"16px"})}):null,e.jsx(j,{children:t}),g?e.jsx($,{onClick:l,children:e.jsx(p,{height:"16px",width:"16px"})}):null]})};a.Title=({children:t})=>e.jsx(c,{color:"content.dark",element:"h2",fontStyles:"bodyMdBold",children:t});a.Description=({children:t})=>e.jsx(c,{color:"content.default",fontStyles:"bodySmRegular",children:t});a.Action=({children:t,dataTestId:s})=>e.jsx(M,{"data-testid":s??"message-action",children:t});export{a as M,n as O};
