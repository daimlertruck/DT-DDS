var w=Object.defineProperty;var d=(t,e)=>w(t,"name",{value:e,configurable:!0});import{j as c}from"./jsx-runtime-Cgz2XvFB.js";import{r as f}from"./index-CwbBKW39.js";import{f as u,d as E}from"./emotion-styled.browser.esm-Cgg3GKEJ.js";import{T}from"./Tooltip-CP0hA9vD.js";import{I as R}from"./Icon-BrO18bYS.js";const A=24,C=80,L=120,j=112,N=24,v=56,m=20,H=32,k=12,O=u.div`
  display: flex;
  position: relative;
  overflow: visible;
  gap: 8px;
...
`,F=u.span`
  ${({theme:t,state:e})=>{const r=d(()=>e==="disabled"?t.palette.content.light:e==="error"?t.palette.error.default:e==="warning"?t.palette.content.default:t.palette.primary.medium,"getColor");return`
      ...
      text-overflow: ellipsis;
    `}}
`,W=d(({title:t,description:e,state:r,isActive:o,orientation:l})=>{const i=f.useRef(null),s=f.useRef(null),[n,a]=f.useState(!1),[x,I]=f.useState(!1);if(f.useEffect(()=>{if(i.current&&t){const p=i.current;a(p.scrollWidth>p.clientWidth)}if(s.current&&e){const p=s.current;I(p.scrollHeight>p.clientHeight)}},[t,e,l]),!t&&!e)return null;const g=d((p,S,y,h,_)=>{if(!p)return null;const b=c.jsx(h,{..._,ref:S,children:p});return y?c.jsxs(T,{children:[b,c.jsx(T.Content,{direction:"right",children:p})]}):b},"renderContent");return c.jsxs(D,{orientation:l,children:[g(t,i,n,z,{state:r,isActive:o}),g(e,s,x,F,{state:r})]})},"StepContent"),P=u.div`
  display: flex;
  align-items: center;
  justify-content: center;
  width: 24px;
  ...
  ${({theme:t,state:e,isActive:r,variant:o})=>{const l=r?t.palette.primary.light:t.palette.content.contrast,i={completed:{bg:t.palette.primary.default,border:t.palette.primary.default},warning:{bg:t.palette.warning.default,border:"transparent"},error:{bg:t.palette.error.default,border:"transparent"},disabled:{bg:t.palette.content.contrast,border:t.palette.border.medium,text:t.palette.content.light},incomplete:{bg:l,border:t.palette.primary.default,text:t.palette.primary.default}},s=i[e]||i.incomplete,n=e==="disabled"?t.palette.border.medium:t.palette.primary.default;return o==="bullet"&&(e==="incomplete"||e==="disabled")?`
    ...
    `}}
`,V=d(({index:t,state:e,variant:r,isActive:o,icon:l})=>{const i=E(),s=d(()=>{const n={completed:"check",warning:"warning",error:"error"};return n[e]?c.jsx(R,{code:n[e],color:i.palette.content.contrast,size:"small"}):r==="bullet"?null:r==="icon"&&l?l:t+1},"getIndicatorContent");return c.jsx(P,{"data-testid":"step-indicator",isActive:o,state:e,variant:r,children:s()})},"StepIndicator"),B=u.span`
  position: absolute;
  ...
  ${({state:t,orientation:e,theme:r})=>{const o=t==="completed"?`${r.palette.primary.default}`:`${r.palette.primary.light}`;return e==="horizontal"?`
      ...
      background-color: ${o};
    `}}
`,G=d(({state:t,orientation:e})=>c.jsx(B,{"data-testid":"trail-line",orientation:e,state:t}),"TrailLine"),$=d(({index:t=0,title:e,description:r,state:o="incomplete",isActive:l=!1,variant:i="number",icon:s,isLast:n=!1,orientation:a,dataTestId:x})=>c.jsxs(O,{isDisabled:o==="disabled",isLast:n,orientation:a,children:[c.jsxs(M,{"data-testid":x??`step-${t}`,isLast:n,orientation:a,children:[c.jsx(V,{icon:s,index:t,isActive:l,state:o,variant:i}),!n&&c.jsx(G,{orientation:a,state:o})]}),c.jsx(W,{description:r,isActive:l,orientation:a,state:o,title:e})]}),"Step"),Z=u.div`
  display: flex;
  ...
  ${({orientation:t="vertical"})=>`
    ...
    align-items: stretch;
  `}
`,X=d(({children:t,orientation:e="vertical",variant:r="number",activeStep:o,dataTestId:l})=>{const i=f.Children.toArray(t),s=i.map((n,a)=>n.type!==$?n:f.cloneElement(n,{...n.props,index:a,variant:r,orientation:e,isLast:a===i.length-1,isActive:n.props.isActive??o===a}));return c.jsx(Z,{"data-testid":l??"stepper",orientation:e,children:s})},"Stepper");X.Step=$;export{X as S};
