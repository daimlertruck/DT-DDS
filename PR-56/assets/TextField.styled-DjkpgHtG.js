import{f as a}from"./emotion-styled.browser.esm-DBghOYGd.js";const d=(t,e)=>({default:e.palette.surface.default,contrast:e.palette.surface.contrast,light:e.palette.surface.light})[t]||e.palette.surface.default,s=a.div`
...
`,b=a.div`
  ...
  `}
`,g=a.div`
  ${({theme:t,isFloatingLabel:e,variant:o,backgroundFill:n,hasError:l})=>{const r=l?t.palette.error.default:t.palette.border.medium,i=l?t.palette.error.default:t.palette.accent.default;return`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
  ...
  `}}
`;export{g as I,b as R,s as T,u as a,p as b,f as c,$ as d};
