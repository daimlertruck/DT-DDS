import{n as o}from"./emotion-styled.browser.esm-Dv69Fly8.js";const d=(e,r)=>({default:r.palette.surface.default,contrast:r.palette.surface.contrast,light:r.palette.surface.light})[e]||r.palette.surface.default,s=o.div`
  ${({theme:e})=>`
    display: flex;
...
`,f=o.div`
  ${({theme:e,variant:r,hasError:t=!1,backgroundFill:l})=>{const a=t?e.palette.error.default:e.palette.primary.default;return`
    ...
    ${r==="outlined"?`border-radius: ${e.shape.formField};
            ...
            &:focus-within, &:hover { { border: 1px solid ${a}};
          `:`border-radius: ${e.shape.formField} ${e.shape.formField} 0 0;
            ...
            &:focus-within, &:hover { { border-bottom: 1px solid  ${a}};
          `};
