import{f as l}from"./emotion-styled.browser.esm-DBghOYGd.js";const p=(t,e)=>({default:e.palette.surface.default,contrast:e.palette.surface.contrast,light:e.palette.surface.light})[t]||e.palette.surface.default,u=l.div`
...
`,y=l.div`
  ...
  `}
`,v=l.div`
  ${({theme:t,isFloatingLabel:e,variant:o,backgroundFill:d,hasError:r,isSearchType:c,scale:i})=>{const a=r?t.palette.error.default:t.palette.border.medium,n=r?t.palette.error.default:t.palette.informative.default;return`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
    ...
    ${e&&!c?`padding-block: ${i==="compact"?"4px":"10px"};
          `:`
  ...
  `}}
`;export{f as I,y as R,u as T,v as a,b,$ as c,g as d,x as e};
