import{f as a}from"./emotion-styled.browser.esm-DBghOYGd.js";const s=(t,e)=>({default:e.palette.surface.default,contrast:e.palette.surface.contrast,light:e.palette.surface.light})[t]||e.palette.surface.default,p=a.div`
  ${({theme:t,isFloatingLabel:e=!0,hasPrefix:o=!1})=>`
    ...
    &:has(input[readonly]:not(input[disabled])):hover {
      label {
...
`,u=a.input`
  ${({theme:t,isFloatingLabel:e,isSearchType:o,readOnly:i})=>`
    ${t.fontStyles.bodyMdRegular}
    border: 0;
    outline: 0;
    width: 100%;
    background-color: inherit;
    color: ${i?t.palette.content.medium:t.palette.content.default};
    ...
    padding: ${e&&!o?`${t.spacing.spacing_50} 0 ${t.spacing.spacing_10} 0`:""};
  `}
`,$=a.div`
...
`,g=a.div`
  ...
  `}
`,x=a.div`
  ${({theme:t,isFloatingLabel:e,variant:o,backgroundFill:i,hasError:r,scale:d})=>{const l=r?t.palette.error.default:t.palette.border.medium,n=r?t.palette.error.default:t.palette.informative.default;return`
    display:flex;
    flex-direction: row;
    align-items: center;
    min-width: 198px;
  ...
  `}}
`;export{x as I,g as R,p as T,$ as a,u as b,f as c,b as d};
