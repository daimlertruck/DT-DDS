...
`,qe=(e,t)=>{let r=e.includes("top")?1:-1,[o,i]=F()?[Pe,We]:[Re(r),Fe(r)];return{animation:t?`${v(o)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${v(i)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}},Ke=c.memo(({toast:e,position:t,style:r,children:o})=>{let i=e.height?qe(e.position||t||"top-center",e.visible):{opacity:0},s=c.createElement(Ve,{toast:e}),a=c.createElement(Ye,{...e.ariaProps},O(e.message,e));return c.createElement(Ue,{className:e.className,style:{...i,...r,...e.style}},typeof o=="function"?o({icon:s,message:a}):c.createElement(c.Fragment,null,s,a))});be(c.createElement);var Qe=({id:e,className:t,style:r,onHeightUpdate:o,children:i})=>{let s=c.useCallback(a=>{if(a){let l=()=>{let n=a.getBoundingClientRect().height;o(e,n)};l(),new MutationObserver(l).observe(a,{subtree:!0,childList:!0,characterData:!0})}},[e,o]);return c.createElement("div",{ref:s,className:t,style:r},i)},Xe=(e,t)=>{let r=e.includes("top"),o=r?{top:0}:{bottom:0},i=e.includes("center")?{justifyContent:"center"}:e.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:F()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${t*(r?1:-1)}px)`,...o,...i}},Ge=L`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`,I=16,lt=({reverseOrder:e,position:t="top-center",toastOptions:r,gutter:o,children:i,toasterId:s,containerStyle:a,containerClassName:l})=>{let{toasts:n,handlers:p}=Ie(r,s);return c.createElement("div",{"data-rht-toaster":s||"",style:{position:"fixed",zIndex:9999,top:I,left:I,right:I,bottom:I,pointerEvents:"none",...a},className:l,onMouseEnter:p.startPause,onMouseLeave:p.endPause},n.map(u=>{let d=u.position||t,f=p.calculateOffset(u,{reverseOrder:e,gutter:o,defaultPosition:t}),g=Xe(d,f);return c.createElement(Qe,{id:u.id,key:u.id,onHeightUpdate:p.updateHeight,className:u.visible?Ge:"",style:g},u.type==="custom"?O(u.message,u):i?i(u):c.createElement(Ke,{toast:u,position:d}))}))};export{lt as F,re as I,k as T,nt as a,oe as b,h as n};
